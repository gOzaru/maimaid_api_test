...
class _LineScaleState extends State<LineScale> with TickerProviderStateMixin, IndicatorController {
  ...
  void initState() {
    ...
    for (int i = 0; i < 5; i++) {
      ...
      ]).animate(CurvedAnimation(parent: _animationControllers[i], curve: cubic)));
